            ...
            <article class="card-body mx-auto" style="max-width: 400px;">
                ...
                <form>
                    ...
                    <div class="form-group input-group">
                        ...
                        <g:textField name="username" placeholder="username" type="text"
                ...
                <!-- form-group end.// -->
                    ...
                    <div class="form-group input-group">
                        ...
                        <input name="confirmPassword" class="form-control" placeholder="Repeat password"
                               type="password">
                    </div>

                    <div class="form-group input-group">
                        <div class="input-group-prepend">
                            <span class="img"><i class="fa-file-image-o"></i></span>
                        </div>
                        <g:uploadForm>
                    ...
                    <p class="text-center">Have an account? <g:link controller="userSetup"
                                                                    action="loginUser">LogIn</g:link></p>
                    <br>
                    ...
                    <p>
                        <a href="https://accounts.google.com/signin/v2/identifier?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&service=mail&sacu=1&rip=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin"
                           class="btn btn-block btn-google"><i class="fab fa-google"></i>   Login via Google+</a>
                        <a href="https://www.facebook.com/" class="btn btn-block btn-facebook"><i
