...
<div class="container">
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal" onclick="getTopicList()">
        Open modal
    </button>
...
<script type="text/javascript">
    function getTopicList() {
        ...
        $.ajax({
            url: '${createLink(controller: "topic", action: "getAllTopics")}',
            method: 'GET',
